          ...
          <div className="content-wrapper">
            <div className={styles.searchBar}>
              <InputFieldComponent
                ...
                onPressEnter={() => searchOrg()}
              ></InputFieldComponent>
              <ButtonComponent
                disabled={isLoading}
                onClick={() => searchOrg()}
                icon={<IconComponent icon={vectorSearch} />}
              >
                button
              </ButtonComponent>
            </div>
                ...
                renderItem={(item: any) => (
                  <List.Item
                    ...
                    actions={[
                      ...
                      />,
                      <Text type="secondary">
                        Updated: {new Date(item.pushed_at).toDateString()}
                      </Text>,
                    ]}
                  >
                    <List.Item.Meta
                      avatar={<Avatar size={80} src={item.owner.avatar_url} />}
                      title={item.name}
